"""``RunRequest.effect_observer``: per-effect completion, canonically pathed.

The same hook runtime plugins receive, exposed to in-process callers so a
live UI can mark effects off as they land instead of diffing snapshots.
"""
